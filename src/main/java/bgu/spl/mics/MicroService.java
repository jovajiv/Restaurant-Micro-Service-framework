    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                callbacks.get(msg.getClass()).call(msg);       // callbacks is hashmap, gets message, returns relevant callback, run callback using .call and execute for specific message recieved.
